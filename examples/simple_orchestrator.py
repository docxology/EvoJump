#!/usr/bin/env python3
"""
Simple Thin Orchestrator Example for EvoJump Package

This demonstrates basic orchestration patterns for EvoJump analysis.
"""
...
def main():
    ...
    print("EvoJump Simple Orchestrator Example")
    print("=" * 50)

    # Create and save sample data
    print("1. Creating sample data...")
    sample_data = create_sample_data()
    data_file = Path("orchestrator_data.csv")
    ...
    output_dir = Path("simple_orchestrator_outputs")
    ...
    results = {
        'summary': 'Simple Orchestrator Results',
        'data_info': {
    ...
    report_file = output_dir / 'orchestrator_report.json'
    with open(report_file, 'w') as f:
        json.dump(results, f, indent=2)

    print(f"   Saved: orchestrator_report.json")
    ...
    print("\n" + "=" * 50)
    print("Simple orchestrator demo completed!")
    print(f"\nOutputs saved to: {output_dir}")
    print("\nGenerated files:")
    print("  - trajectories.png")
    print("  - cross_sections.png")
    print("  - orchestrator_report.json")
