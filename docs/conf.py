...
latex_documents = [
    (master_doc, 'EvoJump.tex', 'EvoJump Documentation',
     'EvoJump Development Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'evojump', 'EvoJump Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EvoJump', 'EvoJump Documentation',
     author, 'EvoJump', 'A Comprehensive Framework for Evolutionary Ontogenetic Analysis.',
     'Science'),
]
